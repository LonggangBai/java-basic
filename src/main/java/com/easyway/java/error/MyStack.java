 ...
 * Package Name:com.easyway.java.error
 * Date:2015-1-21上午10:44:13
 ...
 * 最近在学习Java多线程设计的时候，在网上看到一个面试题目的讨论，虽然楼主所说有些道理
 * ，但感觉还是有些问题，故此在和同事讨论以后还是有了若干收获，在此略作总结。 首先，来看看这个面试题目吧。 
 * 
 * 代码如本类
 * 
 * 
 ...
 * </pre>
 * 
 * ClassName:MyStack <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2015-1-21 上午10:44:13 <br/>
 * 
 * @author longgangbai
 * @version
 * @since JDK 1.6
