 ...
 * File Name:TreadDemo1.java
 * Package Name:com.easyway.java.concurrent
 * Date:2015-2-4下午3:36:57
 ...
 * 
 * 使用实现Runnable接口方式创建线程可以共享同一个目标对象（TreadDemo1 tt=new
 * TreadDemo1();），实现了多个相同线程处理同一份资源。
 * 
 * 然后再看一段来自JDK的解释：
 * 
 ...
 * 
 * 此外，Runnable 为非 Thread 子类的类提供了一种激活方式。通过实例化某个Thread 实例并将自身作为运行目标，就可以运行实现
 * Runnable 的类而无需创建 Thread 的子类。大多数情况下，如果只想重写run() 方法，而不重写其他 Thread 方法，那么应使用
 * Runnable 接口。这很重要，因为除非程序员打算修改或增强类的基本行为，否则不应为该类创建子类。
 * 
 * 
 * 
 * 采用继承Thread类方式：
 ...
 * 
 * ClassName:TreadDemo1 <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2015-2-4 下午3:36:57 <br/>
 * 
 * @author longgangbai
 * @version
 * @since JDK 1.6
...
public class TreadDemoTest {
     ...
     * date: 2015-2-4 下午3:38:22 <br/>
     * 
     * @author Administrator
     * @version TreadDemoTest
     * @since JDK 1.6
     */
    static class TreadDemo1 implements Runnable {
     ...
     * 
     * ClassName: ThreadDemo2 <br/>
     * Function: TODO ADD FUNCTION. <br/>
     * Reason: TODO ADD REASON(可选). <br/>
     * date: 2015-2-4 下午3:39:40 <br/>
     * 
     * @author Administrator
     * @version TreadDemoTest
     * @since JDK 1.6
