 ...
 * File Name:ThreadPoolTools.java
 * Package Name:com.easyway.java.concurrent
 * Date:2015-2-4下午4:16:26
 ...
 * 1、构造线程池时就构造并启动N个线程
 * 
 * 2、往线程池添加任务即往线程池里的等待队列添加任务，添加后唤醒线程执行
 * 
 * 3、每个线程都从等待队列里取任务，然后执行
 * 
 * ClassName:ThreadPoolTools <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2015-2-4 下午4:16:26 <br/>
 * 
 * @author longgangbai
 * @version
 * @since JDK 1.6
 * @see
 */
public class ThreadPoolTools extends ThreadGroup {
    private boolean isClosed = false; // 线程池是否关闭
    private LinkedList workQueue; // 工作队列
    private static int threadPoolID = 1; // 线程池的id


    public ThreadPoolTools(int poolSize) { // poolSize 表示线程池中的工作线程的数量
